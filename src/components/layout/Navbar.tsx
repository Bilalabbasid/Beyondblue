          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              <Link href="/" className="flex-shrink-0 mr-6">
                <Image src="/logo.svg" alt="Beyond Blue IELTS & Consultancy" width={150} height={46} className="h-9 w-auto brightness-0 invert" priority />
              </Link>
          ...
          <>
            ...
            <motion.div variants={drawerVariants} initial="hidden" animate="visible" exit="exit" className="fixed right-0 top-0 bottom-0 z-50 w-80 max-w-[90vw] bg-brand-navy flex flex-col shadow-2xl">
              <div className="flex items-center justify-between px-6 py-4 border-b border-white/10">
                <Image src="/logo.svg" alt="Beyond Blue" width={130} height={40} className="brightness-0 invert h-8 w-auto" />
